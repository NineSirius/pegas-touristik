    ...
    <div className={styles.cont}>
      <div className={styles.card}>
        ...
        <p className={styles.text}>
          ...
          «КАМ <br /> АНД ФЛАЙ», работаем с 2008 года как официальная точка
          продаж туристических <br /> услуг. Ежегодно мы входим в ТОП 10
          агентств по продажам туристических услуг, являемся <br /> лидерами
          продаж, а соответственно лидерами самых низких цен и самого <br />
